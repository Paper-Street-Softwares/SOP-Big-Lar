...
function SectionHeaderNovo({
  ...
  return (
    <MotionDivDownToUp>
      <div className={`mx-auto w-[90%] ${className} ${usage}`}>
        {miniTitle && (
          <span
            className={`font-bold font-secondFont tracking-wider uppercase text-xs mb-2 block text-primary ${miniTag}`}
          >
            {miniTitle}
          </span>
        )}
        ...
        {title && (
          <h2
            className={`text-3xl md:text-4xl font-mainFont font-medium mb-4 text-secondary ${text}`}
          >
